...
data Exercise t m c q a e s = Exercise {
  ...
  questionWidget :: s -> Dynamic t (Map String AudioBuffer) -> c -> e -> Event t (q, a) -> m (Event t s, Event t ExerciseDatum, Event t (Maybe (Synth ())), Event t c, Event t ExerciseNavigation)
}
